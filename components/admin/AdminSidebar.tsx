...
export default function AdminSidebar({ userEmail }: { userEmail: string }) {
  ...
  const handleLogout = async () => {
    ...
    router.push('/rotation/admin/login');
  };
