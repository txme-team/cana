...
const FAQS: FaqItem[] = [
  ...
  {
    category: '신청·참여',
    q: '이단 교단인지는 어떻게 확인하나요?',
    a: '카나가 자체적으로 구축한 교단·교회 데이터베이스와 대조하여 확인합니다. 신청서에 기재하신 소속 교회 정보를 바탕으로 운영진이 개별 검토합니다.',
  },
  {
    category: '신청·참여',
    q: '참가자 연령대는 어떻게 되나요?',
    a: '회차별로 연령대가 다르게 운영됩니다. 정확한 연령대는 각 회차 신청 페이지에서 확인하실 수 있으며, 대체로 20대 중반~30대 후반 직장인으로 구성됩니다.',
  },
  {
    category: '신청·참여',
    q: '심사에서 탈락했거나 이미 참여했는데 다시 신청할 수 있나요?',
    a: '네, 가능합니다. 사전 심사에서 탈락하신 경우 서류를 보완하여 다시 신청하실 수 있고, 이미 참여하신 분도 다른 회차에 재신청하실 수 있습니다.',
  },
  {
    category: '신청·참여',
    q: '참가 비용이 있나요?',
  ...
  // ── 프로필 카드 ────────────────────────────────────────────────────────────
  {
    category: '프로필 카드',
    q: '프로필 카드가 뭔가요?',
    a: '소개팅 전날, 같은 회차에 참가하는 분들의 정보를 담은 카드를 미리 전달해 드립니다. 상대를 미리 파악하고 오실 수 있어, 당일 짧은 자기소개 후엔 바로 깊은 대화를 나누실 수 있습니다.',
  },
  {
    category: '프로필 카드',
  ...
  // ── 당일 진행 ──────────────────────────────────────────────────────────────
  {
    category: '당일 진행',
    q: '당일 어떻게 진행되나요?',
    a: '입장 후 본인 확인을 거쳐 번호와 봉투를 받으십니다. 이후 3분간 자기소개와 Q&A를 진행하고, 이를 바탕으로 첫인상 투표를 합니다. 투표에서 매칭되신 분과는 바로 1:1 데이트를, 매칭되지 않으신 분들은 나머지 참가자들과 로테이션 대화를 이어갑니다. 마음에 드시는 분께는 쪽지에 연락처를 적어 봉투에 넣으시면 됩니다. 모든 순서가 끝난 후 귀가하셔서 봉투 속 쪽지를 확인하시면 됩니다.',
  },
  {
    category: '당일 진행',
    q: '몇 명의 이성과 대화하게 되나요?',
    a: '회차별로 다르며 4~10명 규모로 진행됩니다. 첫인상 투표에서 매칭되면 그 한 분과 1:1 데이트를, 매칭되지 않으면 나머지 참가자분들과 로테이션 대화를 나누게 됩니다.',
  },
  {
    category: '당일 진행',
    q: '대화 시간은 얼마나 되나요?',
    a: '자기소개·Q&A는 3분간 진행됩니다. 이후 1:1 데이트 또는 로테이션 대화는 최소 10분이며, 참가 인원과 매칭 상황에 따라 최대 15분까지 늘어날 수 있습니다.',
  },
  {
    category: '당일 진행',
    q: '몇 시에 도착해야 하나요?',
  ...
  },
  {
    category: '당일 진행',
    q: '매칭 결과를 운영진이 알려주나요?',
    a: '첫인상 투표에 따른 1:1 데이트 여부는 당일 현장에서 바로 확인됩니다. 다만 쪽지 속 연락처 매칭 결과는 운영진이 별도로 알려드리지 않으며, 귀가 후 봉투 속 쪽지를 직접 확인하시고 연락처가 있다면 자유롭게 연락해보시면 됩니다.',
  },
  {
    category: '당일 진행',
    q: '연락처는 어떻게 교환하나요?',
    a: '1:1 데이트 또는 로테이션 대화 중 마음에 드시는 분이 계시면, 쪽지에 연락처를 적어 본인 봉투에 넣으시면 됩니다. 상대방도 동일하게 진행하며, 귀가 후 봉투를 열어 쪽지를 확인하시면 됩니다. 운영진이 개입하거나 매칭 결과를 알리는 방식이 아닌, 쌍방이 직접 확인하는 방식입니다.',
  },
...
function FAQItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border-b border-cana-rule last:border-0">
      ...
      >
        <h3 className="text-base font-medium text-cana-ink">{q}</h3>
        <span
          className={[
