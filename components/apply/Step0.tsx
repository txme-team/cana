  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="rounded-2xl bg-cana/5 px-5 py-5">
        <p className="mb-3 text-base font-semibold text-cana">신청 전 확인해주세요</p>
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-base font-medium text-gray-700">약 10분 소요돼요</p>
              <p className="text-sm text-gray-400">신앙, 가치관, 라이프스타일에 관한 질문들이 있어요</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-base font-medium text-gray-700">마지막 단계에서 서류 인증이 필요해요</p>
              <p className="mb-2.5 text-sm text-gray-400">아래 서류를 미리 준비해주세요</p>
              <div className="flex flex-col gap-2">
                {PREP_DOCS.map((doc) => (
                  <div key={doc.text} className="flex items-start gap-2">
                    <img src={doc.icon} alt="" className="mt-0.5 h-4 w-4 flex-shrink-0" />
                    <p className="text-sm text-gray-500">{doc.text}</p>
                  </div>
                ))}
              </div>
            </div>
